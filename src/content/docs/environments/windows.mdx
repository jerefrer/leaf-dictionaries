...
The best way to use offline dictionaries in Windows is [**GoldenDict-ng**](https://xiaoyifang.github.io/goldendict-ng/).
...
#### Why are complex characters all messed up in some places but not others?
